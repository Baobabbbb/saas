"""
Service de génération d'animations avec Runway ML Gen-3-Alpha-Turbo basé exactement sur le workflow zseedance.json
Implémentation fidèle au workflow n8n avec Gen-3-Alpha-Turbo pour la génération vidéo
"""
...
{{
  ...
  {', '.join([f'"{key}": "Detailed description for {key.lower()}"' for key in scenes_keys])}
    ...
    # Méthode supprimée - Plus d'assemblage nécessaire avec Veo 3.1 Fast
