"""
Service de génération de coloriages avec GPT-4o-mini
Transforme des thèmes ou des photos en pages de coloriage noir et blanc
Utilise DALL-E 3 avec un prompt optimisé pour des coloriages de qualité professionnelle
"""
import os
import uuid
import base64
    ...
    async def _generate_coloring_with_dalle3(
        ...
        try:
            ...
            response = await self.client.images.generate(
                ...
                prompt=final_prompt,
                size="1024x1024",
                quality="standard",  # Utiliser "standard" pour économiser (80% moins cher)
                n=1
            )
