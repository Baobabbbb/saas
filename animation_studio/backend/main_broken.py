...
# Vérification des clés API (avec debug)
print(f"Debug - OPENAI_API_KEY: {bool(OPENAI_API_KEY)}")
print(f"Debug - WAVESPEED_API_KEY: {bool(WAVESPEED_API_KEY)}")
print(f"Debug - FAL_API_KEY: {bool(FAL_API_KEY)}")

if not OPENAI_API_KEY:
    print("❌ OPENAI_API_KEY manquante")
    # raise ValueError("OPENAI_API_KEY manquante dans le fichier .env")
if not WAVESPEED_API_KEY:
    print("❌ WAVESPEED_API_KEY manquante")
    # raise ValueError("WAVESPEED_API_KEY manquante dans le fichier .env")
if not FAL_API_KEY:
    print("❌ FAL_API_KEY manquante")
