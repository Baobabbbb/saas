  ...
  {isGenerating ? (
    ...
    >
      <div style={{ textAlign: 'center', marginBottom: '1rem' }}>
        ...
        <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>
          {animationResult.clips?.length || Math.floor((animationResult.duration_seconds || 30) / 5)} scènes • ~{animationResult.duration_seconds || (animationResult.clips?.length || 6) * 5}s de vidéo
        </p>
      </div>
      <button
